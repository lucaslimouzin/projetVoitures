...
public class Operation extends Voiture{
	...
	// methode pour ajouter une voiture 
		public  ArrayList<Voiture> AjouterVoiture() {
			ArrayList<Voiture> voitures = new ArrayList<Voiture>();		
			boolean ajouterNouvelleVoiture = true;
			...
			while (ajouterNouvelleVoiture) {
				...
				voitures.add (new Voiture(marque,couleur,annee,nb));
